...
class ImageInputNode:
    ...
    '''
    The constructor creates a session to Pepper and initializes the services. Then opens a video stream with the Pepper camera.
    ...
    '''
    Retrieves the latest image from the video source. Then transforms it into a numpy array
...
if __name__ == "__main__":
    ...
    try:
        image_input = ImageInputNode(options.ip, int(options.port), fps=1)
        image_input.start()
